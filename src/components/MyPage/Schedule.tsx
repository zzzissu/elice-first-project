  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-6 w-[60%] h-[55%]">
        <h2 className="text-3xl text-center font-semibold">일정을 작성해주세요</h2>
        <input
          type="text"
    ...
    <div className="sectionDevide flex flex-row items-center justify-center">
      ...
      <div className="leftSite w-[50%]">
        <div className="border-2 h-[650px] w-[85%] mt-16 ml-16 rounded-lg shadow-lg">
          <div className="flex flex-row justify-between pt-10">
            <div className="text-2xl ml-10">개인 일정을 작성해 주세요</div>
            <button
              onClick={handleWriteClickPersonal}
              className="w-16 h-12 mr-6 -mt-2 rounded-md"
              style={{
          ...
          <ul>
            {savedPersonerTitles.length > 0 ? (
              ...
              <li className="flex justify-center pt-56 text-2xl">현재 작성된 개인일정이 없습니다.</li>
            )}
          </ul>
        </div>
      </div>
      ...
      <div className="rightSite w-[50%]">
        <div className="border-2 h-[650px] w-[85%] mt-16 ml-10 rounded-lg shadow-lg">
          <div className="flex flex-row justify-between pt-10">
            <div className="text-2xl ml-10">업무 일정을 작성해 주세요</div>
            <button
          ...
          <ul>
            {savedWorkTitles.length > 0 ? (
              ...
              <li className="flex justify-center pt-56 text-2xl">현재 작성된 업무일정이 없습니다.</li>
            )}
          </ul>
        </div>
      </div>
