...
const Project: React.FC = () => {
    ...
    const fetchEmailData = () => {
        ...
        fetch("http://localhost:4000/api/email/check", {
            method: "GET",
            headers: {
    ...
    const fetchAnnouncements = () => {
        const token = localStorage.getItem("token");
        fetch("http://localhost:4000/api/announcement", {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    const handleSave = (title: string, content: string) => {
        ...
        fetch("http://localhost:4000/api/announcement/post", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    const handleDelete = (id: number) => {
        ...
        fetch(`http://localhost:4000/api/announcement/${id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${token}`,
            },
