    ...
    return (
        <div className="h-auto w-full flex flex-col p-4 space-y-2">
            ...
            <div className="flex w-full space-x-4 p-4">
                <div className="w-1/2 ">
                    <label className="block text-2xl font-bold text-gray-700 font-sans">연차 시작일</label>
                    <input
                        type="date"
                ...
                <div className="w-1/2">
                    <label className="block text-2xl font-bold text-gray-700 font-sans">연차 종료일</label>
                    <input
                        type="date"
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
            ...
            <div className="flex w-full">
                <div className="w-full p-4">
                    <label className="block text-2xl font-sans font-bold text-gray-700">연차 사유</label>
                    <textarea
            ...
            <div className="flex justify-center">
                <button className="text-lg font-sans  w-1/4 bg-mainColor text-white rounded-[10px] p-2 mt-6">
                    결재 신청
                </button>
            </div>
        </div>
