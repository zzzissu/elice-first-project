        ...
        <div className="h-auto w-full flex flex-col justify-center text-center align-middle">
            ...
            <div className="flex pt-10 w-full justify-center">
                <div className="flex w-1/3 justify-center text-center align-middle">
                    <label className="text-2xl font-bold text-gray-700 font-sans mt-1 ">업무명</label>
                    <input
                        type="text"
                        value={taskName}
                ...
                <div className="flex w-1/3">
                    <label className=" text-2xl  font-bold text-gray-700 font-sans mt-1 pr-4">업무 시작</label>
                    <input
                        type="date"
                ...
                <div className="flex w-1/3">
                    <label className=" text-2xl  font-bold text-gray-700 font-sans mt-1 pr-4">업무 종료</label>
                    <input
                        type="date"
                        className=" w-[30%] border-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
            ...
            <div className="flex w-full">
                <div className="w-full">
                    <label className="flex text-2xl font-sans align-middle font-bold text-gray-700 ml-24 mt-8">
                        업무 보고서
                    </label>
                    <textarea
                        value={reportContent}
                        onChange={(e) => setReportContent(e.target.value)}
                        className="text-xl border p-3 rounded-ml mr-7 mt-2 w-[90%] font-sans"
            ...
            <div className="flex w-full">
                <div className="flex w-1/2">
                    <label className="flex text-2xl font-sans align-middle ml-24 font-bold text-gray-700 mt-8">
                        요청사항
                    </label>
                </div>
                <div>
                    <label className="flex text-2xl font-sans align-middle font-bold ml-14 text-gray-700 mt-8">
                        특이사항
                    </label>
                </div>
            </div>
            <div className="flex w-full">
                <div className="flex w-1/2">
                    <textarea
                        className="text-xl border p-3 rounded-ml ml-20 mt-2 w-[90%] font-sans"
                ...
                <div className="flex w-1/2">
                    <textarea
                        className="text-xl border p-3 rounded-ml ml-10 mt-2 w-[85%] font-sans"
            ...
            <div className="flex items-center justify-center mt-4">
                <button
                    ...
                    className={`text-2xl font-sans w-48 bg-mainColor rounded-[10px] mb-4 mt-4 text-white rounded-ml p-4 ${
