    ...
    return (
        <div className="h-auto w-full flex flex-col justify-center text-center align-middle">
            ...
            <div className="flex mt-10">
                <div className="flex w-1/2 justify-center text-center align-middle">
                    <label className=" text-2xl font-bold text-gray-700 font-sans mt-4 pl-7 pr-4">연차 시작일</label>
                    <input
                        type="date"
                        className="mt-1 border-2 w-[30%] rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
                    <input
                        type="time"
                        className="mt-1 border-2 w-[30%] rounded-md border-gray-300 shadow-sm ml-3 focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
                </div>

                <div className="flex w-1/2">
                    <label className=" text-2xl  font-bold text-gray-700 font-sans mt-4 pr-4">연차 종료일</label>
                    <input
                        type="date"
