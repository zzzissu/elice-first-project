    ...
    return (
        ...
        <div className="flex w-full space-x-4 justify-center text-center align-middle mt-7">
            ...
            <div className="flex mt-7">
                <div className="flex w-1/2 justify-center text-center align-middle">
                    <label className=" text-xl font-bold text-gray-700 font-sans mt-1 ml-8 pr-4">외근 시작일</label>
                    <input
                        type="date"
                    ...
                    <input
                        type="time"
                        className="border-2 w-[30%] rounded-md border-gray-300 shadow-sm ml-2 focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
                </div>

                <div className="flex w-1/2">
                    <label className=" text-xl font-bold text-gray-700 font-sans mt-1 pr-4">외근 종료일</label>
                    <input
                        type="date"
