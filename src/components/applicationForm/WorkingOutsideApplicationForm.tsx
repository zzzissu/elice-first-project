    ...
    return (
        <div className="h-auto w-full flex flex-col justify-center text-center align-middle">
            ...
            <div className="flex mt-10">
                <div className="flex w-1/2 justify-center text-center align-middle">
                    <label className=" text-2xl font-bold text-gray-700 font-sans mt-1 ml-8 pr-4">외근 시작일</label>
                    <input
                        type="date"
                        className="border-2 w-[30%] rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
                    <input
                        type="time"
                        className="border-2 w-[30%] rounded-md border-gray-300 shadow-sm ml-3 focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg font-sans"
                    />
                </div>

                <div className="flex w-1/2">
                    <label className=" text-2xl  font-bold text-gray-700 font-sans mt-1 pr-4">외근 종료일</label>
                    <input
                        type="date"
            ...
            <div className="flex w-full">
                <div className="w-full">
                    <label className="flex text-2xl font-sans align-middle font-bold text-gray-700 pl-32 mt-10">
                        외근 사유
                    </label>
                    <textarea
