        ...
        <div className="h-auto w-full flex flex-col justify-center text-center align-middle">
            <div className="flex w-full space-x-4 justify-center text-center align-middle mt-12">
                <div className="flex w-1/2 justify-center text-center align-middle">
                    <label className="block pt-3 text-xl font-sans font-bold text-gray-700 pl-6 pr-8">보내는 사람 </label>
                    <div className='flex justify-center text-gray-700 text-xl w-[60%] font-sans font-bold h-10 bg-gray-300 rounded-lg shadow-lg items-center'>
                        hjh268100@gmail.com
                    </div>
