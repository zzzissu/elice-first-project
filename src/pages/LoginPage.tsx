    ...
    return (
        <div className="flex h-screen min-w-[1280px]">
            <div className="w-1/2 bg-gray-100 flex items-center justify-center">
                <img src="/assets/login.jpg" alt="Login Background" className="object-cover w-full h-full" />
            </div>
            ...
            <div className="w-1/2 flex items-center justify-center bg-white">
                <div className="max-w-md w-full m-36">
                    ...
                    <div className="text-xs flex justify-end space-x-2 mt-4">
                        ...
                        <p> | </p>
                        <button onClick={openPasswordResetModal} className="text-xs text-gray-500 hover:underline">
                            비밀번호를 잊으셨나요?
                        </button>
                    </div>
            ...
            {/* 비밀번호 찾기 모달 */}
            {isModalOpen && (
                <PasswordResetModal onClose={closePasswordResetModal} onEmailConfirm={handleEmailConfirm} />
            )}
        </div>
    );
};
